...
wget -q https://raw.githubusercontent.com/pirozas/badvpn/main/badvpn-master.zip 
...
wget https://raw.githubusercontent.com/pirozas/nodews/main/nodews1.service 
cd /etc 
mkdir -p p7common 
cd p7common 
wget https://raw.githubusercontent.com/pirozas/proxy/main/proxy3.js 
cd $HOME 

cd /etc/systemd/system 
wget https://raw.githubusercontent.com/pirozas/badvpnsvc/main/badvpn.service 
cd $HOME 
sudo rm /etc/shells 
cd /etc/ 
wget https://raw.githubusercontent.com/pirozas/york/main/shells  
cd $HOME 
sudo rm /etc/default/dropbear 
cd /etc/default 
wget https://raw.githubusercontent.com/pirozas/sshdrp/main/dropbear 

cd /etc
wget https://raw.githubusercontent.com/pirozas/ban/main/banner.html
